...
```shell
  docker buildx build -t 22507260/docker-otty-extension:latest . --load
```

To install the extension, use `make install-extension` **or**:

```shell
  docker extension install 22507260/docker-otty-extension:latest
```
...
```shell
  docker extension dev ui-source 22507260/docker-otty-extension:latest http://localhost:3000
```

In order to open the Chrome Dev Tools for your extension when you click on the extension tab, run:

```shell
  docker extension dev debug 22507260/docker-otty-extension:latest
```

Each subsequent click on the extension tab will also open Chrome Dev Tools. To stop this behaviour, run:

```shell
  docker extension dev reset 22507260/docker-otty-extension:latest
```
...
```shell
docker extension update 22507260/docker-otty-extension:latest
```
...
```shell
docker extension rm 22507260/docker-otty-extension:latest
```
